...
- **[阿里云 + Vibe Coding 实战指南](../../action/tools/aliyun-vibe-coding-practical-guide.mdx)**
  - 核心服务速览
  - Docker 化部署完整流程
  - 成本优化策略
  - 常见问题与调试
...
**任务清单**：
- [ ] 安装 Docker 和阿里云 CLI
- [ ] 阅读 [Vibe Coding 范式](../../cognition/methodology/planning/vibe-coding-paradigm.mdx)
- [ ] 本地运行一个 Docker 容器
...
- [Vibe Coding 范式](../../cognition/methodology/planning/vibe-coding-paradigm.mdx)
- [Agent 编排架构](../../cognition/frameworks/ai-coding-agent-architecture.mdx)

### 云服务对比

- [云端 vs 本地执行](../../cognition/frameworks/agent-execution-environment-cloud-vs-local.mdx)
- [Docker Mastery for Agents](../../action/tools/docker-mastery-for-agents.mdx)
